...
loader = PyPDFDirectoryLoader("data/technical_docs")
raw_docs = loader.load()
print(raw_docs[0])

# Split the documents into chunks using symantically
print("Splitting texts from PDF Docs")
# text_splitter = SemanticChunker(google_ef,min_chunk_size=7)
